...
type ProductStatus = "DRAFT" | "ACTIVE" | "INACTIVE" | "UNLISTED"; type Catalog = Awaited<ReturnType<typeof onGetCatalogAdminData>>; type Product = Catalog["items"][number];
...
function deliveryLabel(v: Product["deliveryType"]) { return { CARD_AUTO: "自动卡密", FIXED_CARD: "固定内容", MANUAL: "人工发货", EXPRESS: "物流发货", SUPPLIER: "供应商履约" }[v]; } function statusLabel(v: ProductStatus) { return { DRAFT: "草稿", ACTIVE: "上架", INACTIVE: "下架", UNLISTED: "隐藏(暗链)" }[v]; }
</script>
